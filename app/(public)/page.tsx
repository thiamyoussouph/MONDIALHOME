...
export default function HomePage() {
  return (
    <div className="pt-24">
      ...
      {/* === SECTION B2B (COLLER ICI, DANS LE return) === */}
      <section className="relative py-24 bg-white">
        {/* Arrière-plan très subtil */}
        <div className="absolute inset-0 bg-gradient-to-br from-gray-50/50 to-white pointer-events-none -z-10" />

        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
          <motion.div
            variants={vWrap}
            initial={false} // évite le "blanc" sur mobile
            whileInView="visible"
          ...
          >
            ...
            >
              La Qualité Mondiale,{" "}
              <span className="text-gray-800">Notre Promesse Quotidienne</span>
            </motion.h2>
            ...
            >
              <p className="text-[15.5px] sm:text-base leading-7 text-gray-700">
                Chez Mondiale Home SN, la qualité n&apos;est pas une option,
                c&apos;est le fondement de notre sélection. Forts de notre
                expertise Franco-Turque, nous avons tissé un réseau de
                fabricants qui partagent notre engagement pour
                l&apos;excellence, vous garantissant des produits qui allient
                design, performance, durabilité et qualité.
              </p>
              <p className="text-[15.5px] sm:text-base leading-7 text-gray-700 font-medium">
                Investir avec Mondiale Home SN, c&apos;est investir dans la
                durée.
              </p>
            </motion.div>
            ...
            >
              <div className="p-8 sm:p-10">
                ...
                >
                  Partenariat B2B : Solutions d&apos;Ameublement et BTP pour les
                  Professionnels
                </motion.h3>
                ...
                >
                  Architecte, promoteur, ou chef de projet : vos chantiers
                  exigent fiabilité, conformité et volumes. Mondiale Home SN est
                  structuré pour être l&apos;extension de votre équipe
                  d&apos;approvisionnement international, vous offrant un
                  avantage compétitif crucial. Notre rôle : vous fournir des
                  produits hauts de gamme, une logistique sans faille et un
                  support technique inégalé.
                </motion.p>
                {/* --- Intertitre "Pourquoi Choisir..." (orange + marge bas) --- */}
                <div className="text-center">
                  <motion.h4
                    variants={vItem}
                    className="text-[15px] sm:text-xl font-semibold text-orange-500 tracking-wide"
                  >
                    Pourquoi Choisir Mondiale Home SN comme Partenaire ?
                  </motion.h4>

                  {/* petite barre orange + espace bas */}
                  <div className="mx-auto mt-2 mb-8 h-1 w-16 rounded-full bg-gradient-to-r from-orange-500 to-orange-400" />
                </div>
                ...
                <div className="grid gap-8 sm:grid-cols-3">
                  ...
                  >
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-sm leading-6 text-gray-700">
                      <li>
                        Accès Direct Usine : Bénéficiez de prix optimisés et de
                        la capacité de production de nos usines partenaires en
                        Turquie pour vos commandes en volume.
                      </li>
                      <li>
                        Offres Sur Mesure : Nous vous proposons un catalogue et
                        des tarifs dédiés aux professionnels (accessible sur
                        demande) pour vous aider à maîtriser votre budget dès la
                  ...
                  >
                    ...
                    <ul className="list-disc pl-14 space-y-2 text-sm leading-6 text-gray-700">
                      <li>
                        Gestion des Conteneurs et Douanes : Nous assurons la
                        gestion complète de la logistique, du départ usine au
                        dédouanement à l&apos;arrivée, pour éviter les retards
                        coûteux.
                      </li>
                      <li>
                        Planification de Livraison : Nous coordonnons la
                        livraison sur site pour qu&apos;elle corresponde à
                        l&apos;avancement exact de votre chantier.
                      </li>
                    </ul>
                  </motion.div>
                </div>
                ...
                <motion.div
                  variants={vItem}
                  className="mt-12 text-center border-t border-gray-100 pt-8"
                >
                  ...
                  >
                    Contactez-nous dès aujourd&apos;hui pour une consultation et
                    un accès à notre catalogue professionnel.
                  </a>
                </motion.div>
              </div>
            </motion.div>
      ...
      <section className="relative py-32 bg-gradient-to-br from-white via-gray-50/30 to-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-2xl text-gray-600 leading-relaxed max-w-4xl mx-auto font-light">
                Découvrez l&apos;excellence du design sénégalais dans notre
                showroom de 600m². Chaque pièce raconte une histoire
          ...
          <div className="mb-24">
                        ...
                        <div className="flex items-center space-x-6">
                          ...
                          <div className="flex items-center space-x-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                            ...
                            <span className="font-bold">
                              {featuredProducts[4].rating}
                            </span>
                            <span className="text-sm opacity-80">
                              ({featuredProducts[4].reviews})
                            </span>
                          </div>
                        </div>
            ...
            {/* Grille Secondaire — cartes hauteur égale */}
            <div className="grid lg:grid-cols-3 gap-8 items-stretch">
              {(() => {
                ...
                const gridProducts = wantedCats
                  .map((cat) => allProducts.find((p) => p.category === cat))
                  .filter(Boolean) as typeof allProducts;

                return gridProducts.map((product, index) => (
                  <motion.article
                    key={product.id}
                  ...
                  >
                    <div className="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-700 border border-gray-100 hover:border-accent/30 transform hover:-translate-y-2 h-full flex flex-col">
                      {/* Image fixe */}
                      ...
                      {/* Contenu -> prend la hauteur restante */}
                      <div className="p-8 flex-1 flex flex-col">
                        <div className="space-y-4 flex-1">
                          <div>
                            ...
                            {/* Tronquer pour hauteur égale (nécessite le plugin line-clamp Tailwind) */}
                            <p className="text-gray-600 mt-3 leading-relaxed text-sm line-clamp-3 max-h-16 overflow-hidden">
                              {product.description}
                            </p>
                          </div>
                        </div>
            ...
            <div className="relative bg-gradient-to-r from-primary via-gray-800 to-primary rounded-[3rem] overflow-hidden shadow-2xl">
              ...
              <div className="relative px-8 py-16 lg:px-16 lg:py-20 text-center text-white">
                ...
                <p className="text-xl text-gray-200 mb-12 max-w-3xl mx-auto leading-relaxed">
                  ...
                  Nos conseillers experts vous accompagnent pour créer
                ...
                <div className="grid md:grid-cols-3 gap-8 text-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-gray-300">
                      10h-19h30 • en face de l&apos;arrêt BRT Police Parcelles
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="text-3xl font-bold text-accent">
          ...
          >
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
                Une expérience d&apos;excellence avec des services premium pour
                votre satisfaction totale depuis plus de 15 ans
              </p>
            </div>
          </motion.header>
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 lg:p-12">
              ...
              <header className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Des données concrètes qui témoignent de notre engagement
                  envers l&apos;excellence
                </p>
              </header>
            ...
            <div className="bg-gradient-to-r from-primary to-gray-800 rounded-3xl px-8 py-12 lg:px-16 lg:py-16 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto leading-relaxed">
                  Bénéficiez dès aujourd&apos;hui de notre expertise reconnue
                  pour créer l&apos;intérieur de vos rêves
                </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              ...
              découvrez comment nous pouvons créer l&apos;espace de vos rêves.
            </p>
