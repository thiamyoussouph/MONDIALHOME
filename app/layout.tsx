...
export const metadata: Metadata = {
  ...
  description: 'Mondialehome : N°1 des meubles de qualité au Sénégal. Salon, chambre, bureau, tables. Showroom 500m² à Dakar. Livraison gratuite. ✓ 15 ans d\'expérience ✓ 2500+ clients satisfaits',
  keywords: [
  ...
  twitter: {
    ...
    site: '@mondialehome_sn', // Si vous avez un compte Twitter
    ...
    images: ['/images/twitter-card.jpg'], // À créer
  },
  ...
  verification: {
    ...
    // bing: 'your-bing-verification-code', // Optionnel
  },
  ...
  return (
    <html lang="fr" className="scroll-smooth" suppressHydrationWarning>
      <head>
              ...
              "@graph": [
                {
                  ...
                  "sameAs": [
                    "https://www.facebook.com/mondialehome", // Si existe
                    "https://www.instagram.com/mondialehome_sn" // Si existe
                  ],
                  "hasOfferCatalog": {
                    "@type": "OfferCatalog",
                ...
                },
                {
                  ...
                  "potentialAction": {
                    ...
                    "target": {
                      "@type": "EntryPoint",
                      "urlTemplate": "https://mondialehomesn.com/search?q={search_term_string}"
                    },
        ...
        <link rel="canonical" href="https://mondialehomesn.com" />
      </head>
