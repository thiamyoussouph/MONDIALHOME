    ...
    <main className="min-h-[100svh] grid place-items-center bg-gradient-to-br from-gray-900 via-gray-950 to-black text-gray-100">
      <div className="max-w-xl w-full px-6 py-12 text-center">
        ...
        {cd && (
          <div className="mt-8 grid grid-cols-4 gap-3">
            {[
              ...
              <div key={b.label} className="rounded-2xl bg-white/5 ring-1 ring-white/10 py-4">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="mailto:senmondialhome@gmail.com" className="inline-flex justify-center rounded-xl bg-amber-400/90 hover:bg-amber-400 text-black font-medium px-5 py-3 transition">
            Nous contacter
          </Link>
          <Link href="/" className="inline-flex justify-center rounded-xl bg-white/10 hover:bg-white/15 ring-1 ring-white/10 font-medium px-5 py-3 transition">
            Retour à l’accueil
          </Link>
        </div>
